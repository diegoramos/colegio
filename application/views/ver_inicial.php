			...
			<tbody>
				<?php foreach ($info as $key => $val) {  ?>
					<tr>
						...
						<?php } ?>
						<td><a class="btn btn-success" href="<?php echo base_url();?>inicial/edit/<?=$val->alumno_id?>" title="">Edit</a><a class="btn btn-danger" href="<?php echo base_url();?>inicial/delete/<?=$val->alumno_id?>/<?=$val->tipo_alumno?>" title="">Delete</a><a class="btn btn-primary" href="<?php echo base_url();?>pagos/pagar/<?=$val->alumno_id?>" title="">Pagar</a></td>
					</tr>
				<?php } ?>
			</tbody>
		</table>
